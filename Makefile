...
ogg-winmm.dll: ogg-winmm.c player.c player.h stubs.c stub.h ogg-winmm.def ogg-winmm.rc.o
	gcc -m32 -std=gnu99 -static-libgcc -Wl,--enable-stdcall-fixup -s -O2 -shared -o winmm.dll ogg-winmm.c player.c stubs.c ogg-winmm.def ogg-winmm.rc.o -Ilibs/include -Llibs -lwinmm -l:libvorbisfile.a -l:libvorbis.a -l:libogg.a
