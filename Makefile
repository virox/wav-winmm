...
ogg-winmm.dll: ogg-winmm.c ogg-winmm.rc.o ogg-winmm.def player.c stubs.c
	mingw32-gcc -std=gnu99 -static-libgcc -Wl,--enable-stdcall-fixup -s -O2 -shared -o winmm.dll ogg-winmm.c player.c stubs.c ogg-winmm.def ogg-winmm.rc.o -Ilibs/include -Llibs -lwinmm -l:libvorbisfile.a -l:libvorbis.a -l:libogg.a
